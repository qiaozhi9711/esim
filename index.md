[esim.html](https://github.com/user-attachments/files/24164402/esim.html)
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex space-x-8">
                    <a href="#destinations" class="text-gray-600 hover:text-blue-600 font-medium transition" data-i18n="nav_dest">热门目的地</a>
                    <a href="#how-it-works" class="text-gray-600 hover:text-blue-600 font-medium transition" data-i18n="nav_help">使用教程</a>
                    <a href="#data-analysis" class="text-gray-600 hover:text-blue-600 font-medium transition" data-i18n="nav_cost">资费对比</a>
                </div>
                <div class="flex items-center space-x-3">
                    <button class="text-gray-500 hover:text-gray-900 font-medium text-sm border px-3 py-1 rounded-full">€ EUR</button>
    ...
    <header class="pt-32 pb-20 bg-gradient-to-br from-slate-50 to-blue-50 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <h1 class="text-5xl md:text-6xl font-extrabold text-gray-900 mb-6 tracking-tight">
                <span data-i18n="hero_title_1">连接世界，</span><span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-teal-500" data-i18n="hero_title_2">无缝漫游</span>
            </h1>
            <p class="text-xl text-gray-600 mb-10 max-w-2xl mx-auto" data-i18n="hero_desc">
                告别高昂漫游费。€1 起购，即买即用，覆盖全球 190+ 国家和地区。
            </p>
            ...
            <div class="max-w-2xl mx-auto bg-white p-2 rounded-2xl shadow-xl flex items-center border border-gray-100 transform transition hover:scale-[1.01]">
                <div class="pl-4 text-gray-400 text-xl">🔍</div>
                <input type="text" id="destination-search" placeholder="输入国家 (例如: 泰国, 英国...)" 
    ...
    <section id="destinations" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
                <div>
                    <h2 class="text-3xl font-bold text-gray-900" data-i18n="sec_dest_title">🔥 热门目的地</h2>
                    <p class="text-gray-600 mt-2" data-i18n="sec_dest_sub">覆盖全球 190+ 国家，点击选择套餐</p>
                </div>
                <div class="flex flex-wrap gap-2 bg-gray-50 p-1 rounded-lg shadow-sm border border-gray-200">
                    <button class="filter-btn px-3 py-1.5 text-sm font-medium rounded-md bg-white shadow-sm text-blue-700" onclick="filterCategory('all')" data-i18n="filter_all">全部</button>
                    <button class="filter-btn px-3 py-1.5 text-sm font-medium rounded-md text-gray-600 hover:bg-gray-100" onclick="filterCategory('asia')" data-i18n="filter_asia">亚洲</button>
                    <button class="filter-btn px-3 py-1.5 text-sm font-medium rounded-md text-gray-600 hover:bg-gray-100" onclick="filterCategory('europe')" data-i18n="filter_europe">欧洲</button>
                    <button class="filter-btn px-3 py-1.5 text-sm font-medium rounded-md text-gray-600 hover:bg-gray-100" onclick="filterCategory('americas')" data-i18n="filter_americas">美洲</button>
                    <button class="filter-btn px-3 py-1.5 text-sm font-medium rounded-md text-gray-600 hover:bg-gray-100" onclick="filterCategory('other')" data-i18n="filter_other">其他</button>
                </div>
            </div>
            ...
            <div id="no-results" class="hidden text-center py-20">
                <h3 class="text-xl font-bold text-gray-900" data-i18n="no_results">未找到相关目的地</h3>
            </div>
        </div>
    </section>
    ...
    <section id="how-it-works" class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <h2 class="text-3xl font-bold text-gray-900" data-i18n="sec_step_title">📱 3步轻松激活</h2>
                <p class="text-gray-600 mt-4" data-i18n="sec_step_sub">无需插卡，扫描二维码即可连接全球网络</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2" data-i18n="step_1_title">在线下单</h3>
                    <p class="text-gray-600 text-sm" data-i18n="step_1_desc">选择目的地和流量包，完成支付。系统将在 1 分钟内自动发送 eSIM 二维码。</p>
                </div>
                <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2" data-i18n="step_2_title">扫码安装</h3>
                    <p class="text-gray-600 text-sm" data-i18n="step_2_desc">打开手机设置 -> 蜂窝网络 -> 添加 eSIM。扫描邮件中的二维码即可。</p>
                </div>
                <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2" data-i18n="step_3_title">落地即连</h3>
                    <p class="text-gray-600 text-sm" data-i18n="step_3_desc">到达目的地后，开启“数据漫游”，手机将自动连接当地最佳网络。</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="data-analysis" class="py-20 bg-white border-t border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900" data-i18n="sec_why_title">为什么选择 GlobalConnect?</h2>
                <p class="text-gray-600 mt-2" data-i18n="sec_why_sub">不仅便宜，更稳定。</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div class="bg-gray-50 rounded-2xl p-6 shadow-sm border border-gray-100">
                    <h3 class="text-xl font-bold text-gray-800 mb-2" data-i18n="chart_cost_title">💰 资费对比 (7天/3GB)</h3>
                    <div class="chart-container"><canvas id="costComparisonChart"></canvas></div>
                </div>
                <div class="bg-gray-50 rounded-2xl p-6 shadow-sm border border-gray-100">
                    <h3 class="text-xl font-bold text-gray-800 mb-2" data-i18n="chart_speed_title">⚡ 4G/5G 覆盖指数</h3>
    ...
    <footer class="bg-gray-900 text-white pt-16 pb-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
                <div>
                    <h4 class="text-lg font-bold mb-6 text-white" data-i18n="footer_support">支持</h4>
                    <ul class="space-y-3">
                        <li><a href="mailto:qiaozhi9711@gmail.com" class="text-gray-400 hover:text-white transition">qiaozhi9711@gmail.com</a></li>
                        <li><button onclick="openInfoModal('help')" class="text-gray-400 hover:text-white transition text-left" data-i18n="footer_faq">常见问题 FAQ</button></li>
                        <li><button onclick="openInfoModal('setup')" class="text-gray-400 hover:text-white transition text-left" data-i18n="footer_setup">如何设置 eSIM</button></li>
                    </ul>
                </div>
                <div>
                    <h4 class="text-lg font-bold mb-6 text-white" data-i18n="footer_shop">店铺</h4>
                    <ul class="space-y-3">
                        <li><button onclick="openInfoModal('about')" class="text-gray-400 hover:text-white transition text-left" data-i18n="footer_about">关于我们</button></li>
                        <li><button onclick="openInfoModal('delivery')" class="text-gray-400 hover:text-white transition text-left" data-i18n="footer_delivery">发货政策 (Delivery)</button></li>
                        <li><button onclick="openInfoModal('refund')" class="text-gray-400 hover:text-white transition text-left" data-i18n="footer_refund">退款政策 (Refund)</button></li>
                    </ul>
                </div>
                <div>
                    <h4 class="text-lg font-bold mb-6 text-white" data-i18n="footer_info">信息</h4>
                    <ul class="space-y-3">
                        <li><button onclick="openInfoModal('contact')" class="text-gray-400 hover:text-white transition text-left" data-i18n="footer_contact">联系我们</button></li>
                        <li><button onclick="openInfoModal('affiliate')" class="text-gray-400 hover:text-white transition text-left" data-i18n="footer_affiliate">联盟计划</button></li>
                    </ul>
                </div>
                <div>
                    <h4 class="text-lg font-bold mb-6 text-white" data-i18n="footer_legal">法律条款</h4>
                    <ul class="space-y-3">
                        <li><button onclick="openInfoModal('privacy')" class="text-gray-400 hover:text-white transition text-left" data-i18n="footer_privacy">隐私政策 (Privacy)</button></li>
                        <li><button onclick="openInfoModal('terms')" class="text-gray-400 hover:text-white transition text-left" data-i18n="footer_terms">服务条款 (Terms)</button></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-4xl fade-in">
                    ...
                    <div class="bg-gray-50 px-4 py-4 sm:px-6 border-b border-gray-100 flex justify-between items-center">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 mt-1"><span data-i18n="modal_network">网络</span>: <span id="modal-networks" class="font-medium text-blue-600">--</span></p>
                            </div>
                        </div>
                    ...
                    <div class="px-4 py-6 sm:p-6 grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div class="lg:col-span-2">
                            <h4 class="text-lg font-bold text-gray-900 mb-4" data-i18n="modal_select_plan">选择流量包</h4>
                        ...
                        <div class="bg-gray-50 p-6 rounded-xl border border-gray-200 h-fit flex flex-col justify-between">
                            <div>
                                <h4 class="text-lg font-bold text-gray-900 mb-4" data-i18n="modal_summary">订单摘要</h4>
                                <div class="space-y-4 mb-6">
                                    <div class="flex justify-between text-sm">
                                        <span class="text-gray-500" data-i18n="modal_selected">所选套餐</span>
                                        <span class="font-medium text-gray-900" id="summary-plan" data-i18n="modal_unselected">未选择</span>
                                    </div>
                                    <div class="flex justify-between text-sm">
                                        <span class="text-gray-500" data-i18n="modal_validity">有效期</span>
                                        <span class="font-medium text-gray-900" id="summary-validity">--</span>
                                    </div>
                                    <div class="border-t border-gray-200 pt-4 flex justify-between items-center">
                                        <span class="text-base font-bold text-gray-900" data-i18n="modal_total">应付金额</span>
                                        <span class="text-3xl font-bold text-blue-600" id="summary-price">€0.00</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <button id="buy-btn" onclick="buyDirectly()" disabled 
                                ...
                                <span data-i18n="btn_select_plan">请选择套餐</span>
                            </button>
                            
                            <p class="text-xs text-center text-gray-400 mt-3">🔒 Stripe Secured Payment</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                <div class="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl fade-in">
                    ...
                    <div class="bg-gray-50 px-6 py-4 border-t border-gray-100 text-right">
                        <button class="bg-gray-900 text-white px-6 py-2 rounded-lg text-sm font-bold hover:bg-gray-700 transition" onclick="closeInfoModal()" data-i18n="btn_close">关闭</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        const translations = {
            zh: {
                ...
                nav_help: "使用教程",
                nav_cost: "资费对比",
                hero_badge: "🚀 全球 eSIM 流量超市",
                hero_title_1: "连接世界，",
                hero_title_2: "无缝漫游",
                hero_desc: "告别高昂漫游费。€1 起购，即买即用，覆盖全球 190+ 国家和地区。",
                search_placeholder: "输入国家 (例如: 泰国, 英国...)",
                btn_search: "搜索",
                sec_dest_title: "🔥 热门目的地",
                sec_dest_sub: "覆盖全球 190+ 国家，点击选择套餐",
                filter_all: "全部",
                filter_asia: "亚洲",
                filter_europe: "欧洲",
                filter_americas: "美洲",
                filter_other: "其他",
                no_results: "未找到相关目的地",
                btn_view_plans: "查看详细套餐",
                sold_text: "人已选购",
                sec_step_title: "📱 3步轻松激活",
                sec_step_sub: "无需插卡，扫描二维码即可连接全球网络",
                step_1_title: "在线下单",
                step_1_desc: "选择目的地和流量包，完成支付。系统将在 1 分钟内自动发送 eSIM 二维码。",
                step_2_title: "扫码安装",
                step_2_desc: "打开手机设置 -> 蜂窝网络 -> 添加 eSIM。扫描邮件中的二维码即可。",
                step_3_title: "落地即连",
                step_3_desc: "到达目的地后，开启“数据漫游”，手机将自动连接当地最佳网络。",
                sec_why_title: "为什么选择 GlobalConnect?",
                sec_why_sub: "不仅便宜，更稳定。",
                chart_cost_title: "💰 资费对比 (7天/3GB)",
                chart_speed_title: "⚡ 4G/5G 覆盖指数",
                footer_support: "支持",
                footer_shop: "店铺",
                footer_info: "信息",
                footer_legal: "法律条款",
                footer_faq: "常见问题 FAQ",
                footer_setup: "如何设置 eSIM",
                footer_about: "关于我们",
                footer_delivery: "发货政策 (Delivery)",
                footer_refund: "退款政策 (Refund)",
                footer_contact: "联系我们",
                footer_affiliate: "联盟计划",
                footer_privacy: "隐私政策 (Privacy)",
                footer_terms: "服务条款 (Terms)",
                modal_network: "网络",
                modal_select_plan: "选择流量包",
                modal_summary: "订单摘要",
                modal_selected: "所选套餐",
                modal_unselected: "未选择",
                modal_validity: "有效期",
                modal_total: "应付金额",
                btn_select_plan: "请选择套餐",
                btn_pay_prefix: "立即支付",
                btn_close: "关闭",
                day: "天",
                days: "天"
            ...
            en: {
                ...
                nav_cost: "Pricing",
                hero_badge: "🚀 Global eSIM Marketplace",
                hero_title_1: "Connect World, ",
                hero_title_2: "Seamlessly",
                hero_desc: "Say goodbye to roaming fees. Starts from €1. Global coverage in 190+ countries.",
                search_placeholder: "Enter country (e.g., Thailand, UK...)",
                btn_search: "Search",
                sec_dest_title: "🔥 Top Destinations",
                ...
                sold_text: "Sold",
                sec_step_title: "📱 Easy Activation",
                ...
                chart_cost_title: "💰 Cost Comparison (7 Days/3GB)",
                chart_speed_title: "⚡ 4G/5G Coverage Index",
        ...
        // 更新后的套餐结构 (1, 3, 5, 15, 25, 50 欧元)
        const commonPlans = [
            { id: '1',  name: {zh: '体验包', en: 'Trial'},     days: 1,  price: 1.00,  data: '300MB', stripeLink: LINK_1 },
            { id: '3',  name: {zh: '短途包', en: 'Lite'},      days: 3,  price: 3.00,  data: '1GB',   stripeLink: LINK_3 },
            { id: '5',  name: {zh: '基础包', en: 'Basic'},     days: 5,  price: 5.00,  data: '2GB',   stripeLink: LINK_5 }, 
            { id: '15', name: {zh: '假日包', en: 'Holiday'},   days: 15, price: 15.00, data: '10GB',  stripeLink: LINK_15 },
            { id: '25', name: {zh: '月度包', en: 'Monthly'},   days: 30, price: 25.00, data: '20GB',  stripeLink: LINK_25 },
            { id: '50', name: {zh: '商务包', en: 'Ultra'},     days: 30, price: 50.00, data: '30GB',  stripeLink: LINK_50 } 
        ];

        // 产品数据增加双语名称
        const productsRaw = [
            { id: 'jp', name: {zh: '日本', en: 'Japan'}, region: 'asia', flag: 'https://flagcdn.com/jp.svg', networks: 'Softbank / Docomo', rating: 4.9, sold: '50k+' },
            { id: 'kr', name: {zh: '韩国', en: 'Korea'}, region: 'asia', flag: 'https://flagcdn.com/kr.svg', networks: 'SK Telecom', rating: 4.8, sold: '32k+' },
            { id: 'th', name: {zh: '泰国', en: 'Thailand'}, region: 'asia', flag: 'https://flagcdn.com/th.svg', networks: 'AIS / TrueMove', rating: 4.9, sold: '40k+' },
            { id: 'vn', name: {zh: '越南', en: 'Vietnam'}, region: 'asia', flag: 'https://flagcdn.com/vn.svg', networks: 'Viettel', rating: 4.7, sold: '15k+' },
            { id: 'id', name: {zh: '印尼', en: 'Indonesia'}, region: 'asia', flag: 'https://flagcdn.com/id.svg', networks: 'Telkomsel', rating: 4.6, sold: '20k+' },
            { id: 'eu', name: {zh: '欧洲', en: 'Europe'}, region: 'europe', flag: 'https://flagcdn.com/eu.svg', networks: 'Vodafone / Orange', rating: 4.9, sold: '80k+' },
            { id: 'uk', name: {zh: '英国', en: 'UK'}, region: 'europe', flag: 'https://flagcdn.com/gb.svg', networks: 'EE / O2', rating: 4.8, sold: '25k+' },
            { id: 'fr', name: {zh: '法国', en: 'France'}, region: 'europe', flag: 'https://flagcdn.com/fr.svg', networks: 'Orange', rating: 4.8, sold: '22k+' },
            { id: 'es', name: {zh: '西班牙', en: 'Spain'}, region: 'europe', flag: 'https://flagcdn.com/es.svg', networks: 'Movistar', rating: 4.7, sold: '18k+' },
            { id: 'tr', name: {zh: '土耳其', en: 'Turkey'}, region: 'europe', flag: 'https://flagcdn.com/tr.svg', networks: 'Turkcell', rating: 4.7, sold: '12k+' },
            { id: 'us', name: {zh: '美国', en: 'USA'}, region: 'americas', flag: 'https://flagcdn.com/us.svg', networks: 'AT&T / T-Mobile', rating: 4.7, sold: '45k+' },
            { id: 'au', name: {zh: '澳大利亚', en: 'Australia'}, region: 'other', flag: 'https://flagcdn.com/au.svg', networks: 'Telstra', rating: 4.8, sold: '10k+' },
            { id: 'ae', name: {zh: '阿联酋', en: 'UAE'}, region: 'asia', flag: 'https://flagcdn.com/ae.svg', networks: 'Etisalat', rating: 4.9, sold: '8k+' },
            { id: 'za', name: {zh: '南非', en: 'South Africa'}, region: 'other', flag: 'https://flagcdn.com/za.svg', networks: 'Vodacom', rating: 4.5, sold: '5k+' },
        ];
        ...
        const infoContent = {
            zh: {
                'about': "GlobalConnect Inc. 致力于为全球旅行者提供最便捷、最实惠的 eSIM 数据服务。\n\n我们成立于 2024 年，总部位于新加坡，旨在通过技术消除国际漫游费。目前，我们的服务覆盖全球 190 多个国家和地区，已为超过 10 万名用户提供服务。\n\n我们的使命是让连接变得简单，无论您身在何处。",
                'privacy': "我们非常重视您的隐私。\n\n1. 数据收集：我们仅收集处理订单所需的必要信息（如电子邮件地址）。\n2. 支付安全：所有支付均由 Stripe 安全处理，我们不会接触或存储您的信用卡信息。\n3. 数据使用：您的数据仅用于 eSIM 发货和客户服务，绝不会出售给第三方。\n\n如果您要求删除您的数据，请联系 qiaozhi9711@gmail.com。",
                'terms': "使用本网站即表示您同意以下条款：\n\n1. 服务性质：我们要销售的是数字 eSIM 产品，非实体卡。\n2. 设备兼容性：购买前，用户有责任确认其手机支持 eSIM 功能。\n3. 严禁转售：未经授权，禁止转售我们的二维码。\n4. 免责声明：网络信号受当地运营商基站覆盖影响，我们在特定死角无法保证 100% 信号。",
                'refund': "我们的退款保障政策：\n\n1. 100% 全额退款：如果 eSIM 因技术原因无法在您的设备上激活，我们将全额退款。\n2. 申请时效：请在购买后 30 天内联系我们。\n3. 不可退款情况：如果您购买后发现手机不支持 eSIM，或者已经激活并使用了数据流量，通常不予退款。\n\n退款处理时间通常为 3-5 个工作日。",
                'delivery': "发货政策 (Digital Delivery)：\n\n1. 发货方式：电子邮件发送二维码 (QR Code)。\n2. 发货时间：支付成功后，系统会自动发送邮件，通常在 1-2 分钟内到达。\n3. 未收到邮件：请检查垃圾邮件箱 (Spam)。如果 10 分钟后仍未收到，请联系客服。",
                'contact': "联系我们：\n\n客户支持邮箱: qiaozhi9711@gmail.com\n工作时间: 24/7 全天候支持\n\n如果您遇到连接问题，请在邮件中附上订单号和手机型号，以便我们快速为您解决。",
                'help': "常见问题 (FAQ)：\n\nQ: 我需要插卡吗？\nA: 不需要，eSIM 是虚拟卡，扫码即可用。\n\nQ: 可以保留原来的号码吗？\nA: 可以，您可以同时使用原号接打电话，用 eSIM 上网。\n\nQ: 到达目的地前可以激活吗？\nA: 建议在出发当天或到达后激活。",
                'setup': "设置教程：\n\n1. iOS: 设置 > 蜂窝网络 > 添加 eSIM > 扫描二维码。\n2. Android: 设置 > 网络和互联网 > SIM 卡 > 添加 > 扫描二维码。\n\n注意：激活时需要连接 WiFi 网络。",
                'affiliate': "加入我们的联盟计划：\n\n如果您是旅游博主或网站管理员，欢迎推广我们的 eSIM。\n请发送邮件至 qiaozhi9711@gmail.com 获取详细佣金方案。"
            },
            en: {
                    ...
                    card.innerHTML = `
                        <div>
                            ...
                            <div class="flex items-center gap-3 text-sm text-gray-400 mb-6">
                                <div class="flex items-center text-yellow-400"><span>★</span><span class="text-gray-600 font-medium ml-1">${p.rating}</span></div>
            ...
            product.plans.forEach(plan => {
                ...
                div.innerHTML = `
                    <div>
                        ...
                        <div class="text-xs text-gray-500 mt-1">${planName} · ${validityStr}</div>
                    </div>
                    <div class="text-blue-600 font-bold text-xl">€${plan.price.toFixed(0)}</div>
                `;
        ...
        function updateSummary() {
            ...
            if (selectedPlan) {
                ...
                btn.disabled = false;
                btn.innerHTML = `${t.btn_pay_prefix} €${selectedPlan.price.toFixed(2)}`;
            } else {
        ...
        function openInfoModal(key) {
            ...
            const titles = {
                zh: {
                    'about': '关于我们', 'privacy': '隐私政策', 'terms': '服务条款', 'refund': '退款政策',
                    'delivery': '发货政策', 'contact': '联系我们', 'help': '常见问题', 'setup': '设置教程', 'affiliate': '联盟计划'
                },
                en: {
